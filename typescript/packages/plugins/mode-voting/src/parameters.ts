        ...
        votes: z
            .array(
                z.object({
                    gauge: z
                        .string()
                        .describe("Address of the gauge to vote on"),
                    weight: z
                        .string()
            ...
            .min(1)
            .describe(
                "Array of gauge addresses and their corresponding vote weights"
            ),
    })
) {}
            ...
            .array(
                z.object({
                    ...
                    weight: z
                        .string()
                        .describe(
                            "New weight percentage for this gauge (0-100)"
                        ),
                })
            )
            .min(1)
...
export class GetVotingPowerParameters extends createToolParameters(
    z.object({
        ...
        tokenId: z
            .string()
            .describe("The NFT token ID to check voting power for"),
    })
) {}
